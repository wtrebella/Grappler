...
Shader "Shader Forge/Sky" {
    Properties {
        ...
        _WaveIntensity ("Wave Intensity", Range(0, 1)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += (float3(node_213,node_213,(sin(((o.uv0.r.r+(node_174.g*_WaveSpeed))*6.28318530718))*_WaveIntensity))*2.0+-1.0);
...
////// Emissive:
                ...
                float4 node_4194 = tex2D(_MainTex,node_4530);
