    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += float3(node_213,node_213,(sin(((o.uv0.r.r+(node_174.g*_WaveSpeed))*6.28318530718))*_WaveIntensity));
