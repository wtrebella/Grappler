...
namespace I2.Loc
{
	public partial class LocalizationEditor
	{
		...
		void BuildScriptWithSelectedTerms()
		{
			...
			sb.AppendLine("	{");
			sb.AppendLine("		public static string Get( string Term, bool FixForRTL = false, int maxLineLengthForRTL = 0 ) { return LocalizationManager.GetTermTranslation(Term, FixForRTL, maxLineLengthForRTL); }");
			sb.AppendLine();
